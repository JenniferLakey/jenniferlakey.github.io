 ...
 * NotificationHelper
 * ------------------
 * Centralized utility for sending inventory-related alerts.
 *
 * Architectural Note:
 * This class must ONLY be invoked from the Repository layer.
 * Activities, Adapters, and ViewModels should never call NotificationHelper
 * directly. This ensures:
 *  - Notifications only fire after successful database updates
 *  - No UI-layer duplication of business rules
 *  - Consistent, predictable alert behavior across the app
 *
 * Responsibilities:
 *  - Build and display zero-stock notifications
 *  - Optionally send SMS alerts when SEND_SMS permission is granted
 */
public class NotificationHelper {
     ...
     * Called exclusively by the Repository after DB updates.
     *
    ...
    public static void sendZeroStock(Context ctx, int itemId, String itemName) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(ctx, CHANNEL_ID)
                .setSmallIcon(R.drawable.inventory_alert)
